...
const translations: Record<string, Record<Lang, string>> = {
  ...
  "admin.job.preset.oven": { en: "Oven", es: "Horno" },
  "admin.job.preset.fridge": { en: "Fridge", es: "Refrigerador" },
  "admin.job.preset.windows": { en: "Windows", es: "Ventanas" },
  "admin.job.preset.laundry": { en: "Laundry", es: "Lavandería" },
  "admin.job.preset.baseboards": { en: "Baseboards", es: "Zócalos" },
  "admin.job.preset.organizing": { en: "Organizing", es: "Organización" },
  ...
  "admin.cd.everyXweeks": { en: "Every {x} Weeks", es: "Cada {x} Semanas" },
