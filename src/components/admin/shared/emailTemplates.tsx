  ...
  return [
    ...
    },
    {
      ...
      body: (b) => {
        ...
        const depositDisplay = amt ? `$${(parseFloat(amt) * 0.25).toFixed(2)}` : "25%";
        return `Thank you for letting us visit your home! Based on our walk-through, here is your personalized cleaning estimate:\n\n\u{1F3E0} Service: ${serviceLabel}\n\u{1F4CD} Address: ${b.street}, ${b.city}, CA ${b.zip}\n\u{1F4D0} Size: ${b.sqft ? b.sqft + " sqft" : "N/A"} | ${b.bedrooms || "\u2014"} bed / ${b.bathrooms || "\u2014"} bath\n\u{1F4CB} Frequency: ${frequencyLabel}\n\n\u{1F4B0} Estimated Quote: ${quoteDisplay} per visit\n\n\u{1F4B3} DEPOSIT: A 25% deposit (${depositDisplay}) is required to secure your cleaning date. You can approve your quote and pay your deposit all in one step using the button below!\n\n\u{1F4B3} Payment Options:\n\u2022 Credit Card — pay securely online after approving (3% processing fee)\n\u2022 Zelle (preferred, no fees!) — send to (530) 966-0752\n\n\u26A0\uFE0F Please note: This is an estimate and is subject to change depending on additional services requested or removed at the time of cleaning. The remaining balance is due on the day of your cleaning.\n\nOr call us at (530) 966-0752.\n\nWe'd love to make your home sparkle!\nBetty & the Maid for Chico Team`;
      },
    },
    {
